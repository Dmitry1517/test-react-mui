  ...
  return (
      ...
      <Box component="section" sx={{padding: '20px 0px', background: '#f1f1f1'}}>
        <Container>
          <Stack spacing={3}>
            <Stack spacing={2}>
              <Typography sx={{fontSize: '18px', fontWeight: '600', fontFamily: "'SanFranciscoProText', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"}}>Способ вывода</Typography>
            ...
            <Stack spacing={2}>
              <Typography sx={{fontSize: '18px', fontWeight: '600', fontFamily: "'SanFranciscoProText', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"}}>Объемы</Typography>
            ...
            <Stack spacing={2}>
              <Typography sx={{fontSize: '18px', fontWeight: '600', fontFamily: "'SanFranciscoProText', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"}}>Реквизиты</Typography>
              <Stack spacing={1}>
